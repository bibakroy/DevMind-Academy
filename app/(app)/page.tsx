      ...
      <main className="relative z-10">
        <section className="px-6 lg:px-12 pt-16 pb-24 max-w-7xl mx-auto">
          <div className="flex flex-col items-center text-center">
            ...
            >
              Join DevMind Academy and learn from expertly crafted courses,
        ...
        <section className="px-6 lg:px-12 py-20 max-w-7xl mx-auto">
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <div
                key={plan.tier}
                className={`relative p-8 rounded-2xl ${plan.bgGlow} border ${
                  plan.borderColor
                } ${
        ...
        <footer className="px-6 lg:px-12 py-12 border-t border-zinc-800/50 max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-3">
              ...
              <span className="font-bold">DevMind Academy</span>
            </div>
            ...
            <p className="text-sm text-zinc-600">
              © 2024 DevMind Academy. All rights reserved.
            </p>
          </div>
        </footer>
      </main>
